...
const Footer = () => {
    return (
        <footer className="p-10 bg-gray-300 mt-10">
            <div className="footer my-5">
                <div className="">
                    ...
                    <div className='flex gap-2 mt-2'>
                        <FaGoogle className='w-7 h-7 p-2 mr-2 bg-primary rounded-full text-white'></FaGoogle>
                        <FaTwitter className='w-7 h-7 p-2 mr-2 bg-primary rounded-full text-white'></FaTwitter>
                        <FaInstagram className='w-7 h-7 p-2 mr-2 bg-primary rounded-full text-white'></FaInstagram>
                        <FaLinkedin className='w-7 h-7 p-2 mr-2 bg-primary rounded-full text-white'></FaLinkedin>
                    </div>
                </div> 
                <div>
                    <h2 className="text-primary font-bold text-2xl">Contact</h2> 
                    <div className="flex gap-2 items-center">
                        <FaLocationArrow className='w-7 h-7 p-2 text-secondary'></FaLocationArrow>
                        <p>123, Lorem ipsum, dolor sit amet, consectetur adipiscing, City, State, Country - 123 456</p>
                    </div>
                    <p className='flex my-2 items-center'><FaPhone className='w-7 h-7 p-2 text-secondary mr-2'></FaPhone> <span>(514) 327-9524
    </span></p>
                    <p className='flex items-center'><FaEnvelope className='w-7 h-7 p-2 text-secondary mr-2'></FaEnvelope> <span>toyondoll@brown.com</span></p>
                </div> 
                <div>
                    <h2 className=" text-primary font-bold text-2xl">Information</h2> 
                ...
                <div>
                    <span className=" text-primary font-bold text-2xl">Why Buy From Us</span> 
            ...
            <div className="footer md:px-10 py-5 md:py-4 border-t">
                <div className="items-center grid-flow-col">
                    ...
                    <p>UniPlanet Industries Ltd. <br/>Providing reliable tech since 1992</p>
                </div> 
